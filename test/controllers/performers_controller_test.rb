...
class PerformersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create performer" do
    assert_difference("Performer.count") do
      post performers_url, params: { performer: { bio: @performer.bio, name: @performer.name } }
    end
  ...
  test "should update performer" do
    patch performer_url(@performer), params: { performer: { bio: @performer.bio, name: @performer.name } }
